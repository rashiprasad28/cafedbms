...
if (isset($_REQUEST['id'])) {
	...
	$sql = 'SELECT * FROM `food` ORDER BY `food`.`cat_id` ASC ';
			...
			<div class="col s12 m4">
				<div class="card">
				    <div class="card-image waves-effect waves-block waves-light">
				      <img class="activator" src="images/food<?php echo $f; $f++; ?>.jpg" height="350">
				    </div>
				    <div class="card-content">
				      <span class="card-title activator grey-text text-darken-4"><a class="black-text" href=""><?php echo $arr_all[$i+$j-2]['fname']; ?></a><a class="black-text" href=""><?php echo $arr_all[$i+$j-2]['price']; ?></a><i class="material-icons right">more_vert</i></span>
				      <div class="card-content">
